...
interface CartesiComputeInterfaceInterface extends ethers.utils.Interface {
  functions: {
...
export class CartesiComputeInterface extends Contract {
  ...
  interface: CartesiComputeInterfaceInterface;
