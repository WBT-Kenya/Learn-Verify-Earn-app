...
interface CartesiComputeInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    "CartesiComputeCreated(uint256)": EventFragment;
    "CartesiComputeFinished(uint256,bytes32)": EventFragment;
    "ChallengeStarted(uint256)": EventFragment;
    "ClaimSubmitted(uint256,bytes32)": EventFragment;
    "Confirmed(uint256,address)": EventFragment;
    "DriveInserted(uint256,tuple)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "CartesiComputeCreated"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "CartesiComputeFinished"): EventFragment;
...
export class CartesiCompute extends Contract {
  ...
  filters: {
    CartesiComputeCreated(
      _index: null
    ): TypedEventFilter<[BigNumber], { _index: BigNumber }>;

    CartesiComputeFinished(
      _index: null,
      _state: null
    ): TypedEventFilter<
      [BigNumber, string],
      { _index: BigNumber; _state: string }
    >;
    ...
    Confirmed(
      ...
      [BigNumber, string],
      { _index: BigNumber; _confirmParty: string }
    >;
